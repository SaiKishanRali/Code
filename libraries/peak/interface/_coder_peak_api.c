...
void peak_api(const mxArray * const prhs[1], int32_T nlhs, const mxArray *plhs[1])
{
  ...
  emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "input", input);
...
/* End of code generation (_coder_peak_api.c) */
